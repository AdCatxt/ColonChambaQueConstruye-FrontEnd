...
export default function CompaniesAprovedPage() {
  ...
  const sectionConfig = {
    talents: {
      ...
      description: 'Consulta los perfiles que han sido aprobados.',
    },
  };
  ...
  const fetchApprovedUsers = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error("Error al obtener las solicitudes aprobadas");
      }
    } catch (error) {
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-16 text-gray-400 text-center bg-gray-50 rounded-xl border border-dashed border-gray-300">
              ...
              <div>
                ...
                <p className="text-sm font-normal mt-1">
                  Intenta con otras palabras clave o no hay perfiles aprobados aún.
                </p>
              </div>
            </div>
          )}
